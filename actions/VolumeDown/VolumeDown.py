...
class VolumeDown(ActionBase):
    ...
    def get_config_rows(self) -> list:
        ...
        self.sync_row.set_title("Sync settings to all Volume Down buttons")
        self.sync_row.set_subtitle("Changes here apply to all Volume Down actions")
    ...
    def _sync_to_siblings(self, settings: dict):
        ...
        for action in self.plugin_base._registered_actions:
            if action is self or type(action).__name__ != "VolumeDown":
                continue
            try:
